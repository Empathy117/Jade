...
SCENES = [
    ...
    ("p1034", "上学辞行", "jiamu", "morning", None, ["fresh", "dutiful"], 0.22, "xianting", []),
    ("p1037", "书房训话", "study", "morning", None, ["stern", "wry"], 0.3, "xianting", []),
    ("p1040", "顽童闹学堂", "school", "day", None, ["mischief", "rowdy"], 0.45, "yuzhou", []),

    # ---- 第十回 金寡妇贪利权受辱 张太医论病细穷源 ----
    ("p1085", "金寡妇忍气", "commonhouse", "day", None, ["aggrieved", "calculating"], 0.3, "xianting", []),
    ...
    ("p1113", "贾敬寿辰家宴", "ningfu", "day", None, ["festive", "undertow"], 0.26, "yanle", []),
    ...
    ("p1161", "毒设相思局", "neiyuan", "day", None, ["predatory", "scheming"], 0.45, "anliu", []),
    ...
    ("p1196", "凤姐夜梦可卿", "neiyuan", "night", None, ["dream", "portent"], 0.5, "taixu", []),
    ...
    ("p1267", "协理立威", "ningfu", "morning", None, ["brisk", "iron"], 0.38, "xianting", []),
    ...
    ("p1345", "路谒北静王", "capital", "day", None, ["courtly", "admiring"], 0.34, "xianting", []),
    ...
    ("p1396", "弄权果报", "study", "night", None, ["cold", "retribution"], 0.45, "anliu", []),
    ...
    ("p1479", "痛悼秦钟", "neiyuan", "day", None, ["grieving"], 0.3, "aiyin", []),
    ...
    ("p1773", "元宵既过", "neiyuan", "day", None, ["slack", "recuperating"], 0.2, "xianting", []),
    ...
    ("p1844", "正言弹妒意", "jiamu", "day", None, ["squabble", "protective"], 0.3, "xianting", []),
    ...
    ("p1882", "晨妆同盥", "jiamu", "morning", None, ["intimate", "fresh"], 0.22, "chunjiang", []),
    ...
    ("p1958", "筹办生辰", "neiyuan", "day", None, ["planning"], 0.2, "xianting", []),
    ...
    ("p2068", "奉旨入园", "ronghall", "day", None, ["formal", "expectant"], 0.25, "xianting", []),
    ...
    ("p2152", "鸳鸯传话", "jiamu", "day", None, ["domestic"], 0.2, "xianting", []),
    ...
    ("p2208", "遗帕魂牵", "yihong", "morning", None, ["yearning"], 0.25, "chunjiang", []),
    ...
    ("p2287", "蜂腰桥传心事", "yihong", "day", None, ["hopeful", "scheming"], 0.26, "xianting", []),
    ...
    ("p2348", "芒种饯花会", "daguan_spring", "morning", None, ["festival", "bright"], 0.25, "yuzhou", []),
    ...
    ("p2415", "山坡诉悲释嫌", "flowermound", "day", None, ["reconciled", "tender"], 0.4, "hangong", []),
    ...
    ("p2544", "倾府起行", "capital", "morning", None, ["procession", "festive"], 0.3, "yanle", []),
    ...
    ("p2618", "潇湘请罪", "xiaoxiang", "morning", None, ["contrite", "melting"], 0.32, "chunjiang", ["bamboo"]),
    ...
    ("p2661", "袭人见血", "yihong", "dawn", None, ["alarmed"], 0.35, "xianting", []),
    ...
    ("p2713", "麒麟话旧", "yihong", "day", None, ["candid", "clashing"], 0.35, "xianting", []),
    ...
    ("p2748", "祸事叠至", "ronghall", "day", None, ["dread", "mounting"], 0.6, "anliu", []),
    ...
    ("p2786", "伤后探望", "yihong", "day", None, ["aching", "tender"], 0.42, "hangong", []),
    ...
    ("p2839", "鹦鹉架前", "xiaoxiang", "day", None, ["wistful"], 0.28, "hangong", ["bamboo"]),
    ...
    ("p2886", "月例风波", "neiyuan", "day", None, ["accounting", "cold"], 0.3, "xianting", []),
    ...
    ("p2931", "贾政点差", "ronghall", "day", None, ["formal"], 0.2, "xianting", []),
    ...
    ("p3059", "藕香榭蟹宴", "shuixie", "day", None, ["autumnal", "feasting"], 0.26, "yuzhou", []),
    ...
    ("p3236", "散社闲评", "daguan_autumn", "day", None, ["easy", "chatty"], 0.22, "xianting", []),
    ...
    ("p3282", "晓晴排宴", "daguan_autumn", "morning", None, ["crisp", "festive"], 0.25, "yuzhou", []),
    ...
    ("p3358", "续宴茄鲞", "banquet", "day", None, ["comic", "groaning"], 0.28, "yanle", []),
    ...
    ("p3428", "姥姥满载辞行", "neiyuan", "day", None, ["grateful", "parting"], 0.24, "xianting", []),
    ...
    ("p3614", "赖嬷嬷说教", "neiyuan", "day", None, ["chatty", "earthy"], 0.22, "xianting", []),
    ...
    ("p3737", "老太太斥媒", "jiamu", "day", None, ["chastened", "cardgame"], 0.3, "xianting", []),
    ...
    ("p3783", "薛蟠议行商", "lixiang", "day", None, ["restless", "practical"], 0.24, "xianting", []),
    ...
    ("p3856", "众芳齐聚", "jiamu", "day", None, ["arrivals", "delight"], 0.26, "yuzhou", []),
    ...
    ("p3926", "芦雪广争联", "luxue", "day", "snow", ["blazing", "joyous"], 0.35, "yuzhou", ["snowwind"]),
    ...
    ("p4171", "怀古十咏", "qiushuang", "day", None, ["erudite", "mysterious"], 0.26, "pinghu", []),
    ...
    ("p4342", "裘成力尽", "yihong", "dawn", None, ["spent", "grateful"], 0.3, "xianting", []),
    ...
    ("p4427", "女先儿说书", "banquet", "night", None, ["storytelling", "warm"], 0.3, "yanle", []),
    ...
    ("p4498", "太妃薨凤姐病", "neiyuan", "day", None, ["grey", "transition"], 0.3, "xianting", []),
    ...
    ("p4548", "兴利除宿弊", "ronghall", "day", None, ["reformist", "brisk"], 0.3, "xianting", []),
    ("p4571", "甄家来访梦真", "jiamu", "day", None, ["uncanny", "mirror"], 0.3, "taixu", []),

    # ---- 第五十七回 慧紫鹃情辞试忙玉 慈姨妈爱语慰痴颦 ----
    ("p4603", "情辞试忙玉", "xiaoxiang", "day", None, ["probing", "fond"], 0.3, "chunjiang", ["bamboo"]),
    ...
    ("p4681", "遣散梨园", "neiyuan", "day", None, ["grey", "dispersal"], 0.3, "xianting", []),
    ...
    ("p4743", "送灵起程", "capital", "morning", None, ["procession", "quiet"], 0.25, "xianting", []),
    ...
    ("p4778", "蔷薇硝茉莉粉", "yihong", "day", None, ["swap", "brewing"], 0.28, "xianting", []),
    ...
    ("p4888", "角门斗嘴", "neiyuan", "day", None, ["sharp", "comic"], 0.24, "xianting", []),
    ...
    ("p4938", "大事化小", "neiyuan", "morning", None, ["deflated", "wry"], 0.24, "xianting", []),
    ...
    ("p5040", "夜宴筹备", "yihong", "dusk", None, ["conspiratorial", "giddy"], 0.26, "xianting", []),
    ...
    ("p5157", "丧仪如仪", "mourning", "day", None, ["rites", "weary"], 0.35, "aiyin", ["temple"]),
    ...
    ("p5260", "小花枝巷", "commonhouse", "night", None, ["illicit", "honeyed"], 0.3, "chunjiang", []),
    ...
    ("p5341", "薛家闻信", "lixiang", "day", None, ["sighing", "practical"], 0.26, "xianting", []),
    ...
    ("p5385", "赚入大观园", "commonhouse", "day", None, ["silken", "venomous"], 0.45, "anliu", []),
    ...
    ("p5430", "拜见贾母", "jiamu", "day", None, ["veiled", "performative"], 0.35, "anliu", []),
    ...
    ("p5479", "岁暮诸务", "neiyuan", "day", None, ["administrative", "wintry"], 0.26, "xianting", []),
    ...
    ("p5571", "八旬大庆", "banquet", "day", None, ["pomp", "thronged"], 0.35, "yanle", []),
    ...
    ("p5647", "守秘慰司棋", "daguan_autumn", "day", None, ["anxious", "discreet"], 0.32, "xianting", []),
    ...
    ("p5885", "甄家风声", "daoxiang", "day", None, ["foreboding", "hushed"], 0.4, "anliu", []),
    ...
    ("p5969", "品笛感凄清", "moonpav", "night", None, ["desolate", "tearful"], 0.45, "hangong", []),
    ...
    ("p6133", "人参风波", "neiyuan", "day", None, ["depleted", "scrounging"], 0.32, "xianting", []),
    ...
    ("p6214", "袭人名分定", "jiamu", "morning", None, ["settling", "subdued"], 0.3, "xianting", []),
    ...
    ("p6540", "四美钓游鱼", "shuixie", "day", None, ["diminished", "pastime"], 0.3, "pinghu", []),
    ...
    ("p6577", "下学访潇湘", "xiaoxiang", "dusk", None, ["affinity", "studious"], 0.28, "chunjiang", ["bamboo"]),
    ...
    ("p6731", "打点刑名", "lixiang", "day", None, ["bribery", "grinding"], 0.4, "anliu", []),
    ("p6744", "淑女解琴书", "xiaoxiang", "day", None, ["refined", "tender"], 0.28, "chunjiang", ["bamboo"]),

    # ---- 第八十七回 感秋深抚琴悲往事 坐禅寂走火入邪魔 ----
    ("p6771", "感秋故园书", "xiaoxiang", "day", None, ["autumnal", "homesick"], 0.4, "hangong", []),
    ...
    ("p6840", "博庭欢", "jiamu", "day", None, ["doting", "pious"], 0.26, "xianting", []),
    ...
    ("p6869", "寒冬诸事", "neiyuan", "day", None, ["wintry", "routine"], 0.28, "xianting", []),
    ...
    ("p6905", "心病心药", "xiaoxiang", "day", None, ["reprieve", "frail"], 0.4, "hangong", []),
    ...
    ("p6932", "宝蟾设计", "lixiang", "night", None, ["lust", "scheme"], 0.4, "anliu", []),
    ...
    ("p6968", "评女传", "jiamu", "day", None, ["didactic", "cozy"], 0.26, "xianting", []),
    ("p6975", "玩母珠参聚散", "study", "day", None, ["portent", "melancholy"], 0.32, "pinghu", []),

    # ---- 第九十三回 甄家仆投靠贾家门 水月庵掀翻风月案 ----
    ("p7023", "临安伯观剧", "banquet", "day", None, ["theatrical", "recognition"], 0.3, "yuzhou", []),
    ...
    ("p7059", "风波善后", "ronghall", "day", None, ["patching", "uneasy"], 0.3, "xianting", []),
    ...
    ("p7099", "扶乩问玉", "longcui", "day", None, ["occult", "grasping"], 0.4, "anliu", []),
    ...
    ("p7148", "迷本性回馆", "xiaoxiang", "day", None, ["daze", "sinking"], 0.6, "aiyin", []),
    ...
    ("p7197", "魂魄游离", "yihong", "day", None, ["liminal", "otherworld"], 0.55, "taixu", []),
    ...
    ("p7223", "病愈谈书", "neiyuan", "day", None, ["convalescent", "wry"], 0.3, "xianting", []),
    ...
    ("p7269", "薛案反复", "court", "day", None, ["grinding", "costly"], 0.4, "anliu", []),
    ...
    ("p7286", "月夜感幽魂", "daguan_autumn", "night", None, ["ghostly", "shiver"], 0.5, "anliu", ["snowwind"]),
    ...
    ("p7318", "探春辞行", "neiyuan", "day", None, ["departure", "brave"], 0.45, "yangguan", []),
    ...
    ("p7351", "部里打点", "neiyuan", "day", None, ["procedural"], 0.32, "xianting", []),
    ...
    ("p7377", "小鳅生大浪", "capital", "day", None, ["street", "rumbling"], 0.32, "xianting", []),
    ...
    ("p7399", "锦衣军查抄", "ronghall", "day", None, ["raid", "catastrophe", "rout"], 0.8, "bianzheng", []),
    ...
    ("p7437", "惊悸病倒", "jiamu", "day", None, ["shaken", "frail"], 0.5, "aiyin", []),
    ...
    ("p7458", "复世职", "court", "day", None, ["reprieve", "qualified"], 0.4, "xianting", []),
    ...
    ("p7490", "家计重整", "ronghall", "day", None, ["salvage", "plainer"], 0.35, "xianting", []),
    ...
    ("p7521", "释疑劝慰", "yihong", "night", None, ["soothing", "candid"], 0.35, "xianting", []),
    ...
    ("p7548", "寿终归地府", "jiamu", "day", None, ["deathbed", "solemn", "love"], 0.62, "aiyin", []),
    ("p7551", "力诎失人心", "mourning", "day", None, ["understaffed", "humiliated"], 0.48, "anliu", []),

    # ---- 第一一一回 鸳鸯女殉主登太虚 狗彘奴欺天招伙盗 ----
    ("p7574", "辞灵之夜", "mourning", "night", None, ["vigil", "drained"], 0.5, "aiyin", []),
    ...
    ("p7601", "失盗善后", "neiyuan", "day", None, ["reckoning", "sullen"], 0.4, "anliu", []),
    ...
    ("p7631", "寺中余悸", "tiejian", "day", None, ["shaken", "murmuring"], 0.4, "anliu", []),
    ...
    ("p7649", "历幻返金陵", "neiyuan", "night", None, ["death", "passing"], 0.55, "aiyin", []),
    ("p7656", "甄应嘉来访", "ronghall", "day", None, ["courtesy", "subdued"], 0.32, "xianting", []),

    # ---- 第一一五回 惑偏私惜春矢素志 证同类宝玉失相知 ----
    ("p7666", "惜春矢素志", "neiyuan", "day", None, ["vow", "austere"], 0.42, "kongshan", []),
    ...
    ("p7693", "重游幻境", "taixu", "dream", None, ["revelation", "cyclecomplete"], 0.6, "taixu", []),
    ...
    ("p7717", "双护玉", "yihong", "day", None, ["tugofwar", "fervent"], 0.48, "anliu", []),
    ("p7725", "恶子独承家", "study", "night", None, ["dissolute", "takeover"], 0.42, "anliu", []),

    # ---- 第一一八回 记微嫌舅兄欺弱女 惊谜语妻妾谏痴人 ----
    ("p7740", "惜春志决", "neiyuan", "day", None, ["renounce", "accepted"], 0.42, "kongshan", []),
    ("p7745", "舟中家书", "journey", "day", None, ["riverjourney", "scheming"], 0.4, "anliu", []),
    ("p7757", "惊谜语谏痴人", "yihong", "day", None, ["riddle", "valediction"], 0.45, "kongshan", []),

    # ---- 第一一九回 中乡魁宝玉却尘缘 沐皇恩贾家延世泽 ----
    ("p7777", "却尘缘拜别", "yihong", "morning", None, ["departure", "finalbow"], 0.5, "kongshan", []),
    ("p7782", "巧姐之难", "neiyuan", "day", None, ["plot", "rescue"], 0.5, "bianzheng", []),
    ("p7785", "姥姥庄上", "rural", "day", None, ["refuge", "earthy"], 0.38, "xianting", []),
    ("p7790", "中魁与失踪", "neiyuan", "day", None, ["vanish", "bittersweet"], 0.55, "aiyin", []),
    ("p7797", "沐恩延世泽", "ronghall", "day", None, ["pardon", "restoration"], 0.38, "xianting", []),

    # ---- 第一二〇回 甄士隐详说太虚情 贾雨村归结红楼梦 ----
    ("p7811", "袭人心事", "yihong", "day", None, ["torn", "quiet"], 0.4, "hangong", []),
    ("p7814", "毘陵驿雪影", "snowend", "day", "snow", ["finalbow", "vast", "transcendent"], 0.65, "kongshan", ["snowwind"]),
    ("p7819", "赦罪归家", "ronghall", "day", None, ["afterglow", "subdued"], 0.35, "xianting", []),
    ("p7826", "袭人别嫁", "commonhouse", "day", None, ["reluctant", "newlife"], 0.4, "yangguan", []),
    ("p7830", "急流津归结", "countryside", "day", None, ["frameclose", "dreamlike"], 0.45, "taixu", []),
]
